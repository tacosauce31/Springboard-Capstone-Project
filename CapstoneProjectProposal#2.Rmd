...
This dataset's summary is the following:
```{r cnt_km_year_powerPS_minPrice_maxPrice_avgPrice_sdPrice}
summary(cnt_km_year_powerPS_minPrice_maxPrice_avgPrice_sdPrice)

```

This dataset's structure is the following:
```{r cnt_km_year_powerPS_minPrice_maxPrice_avgPrice_sdPrice}
str(cnt_km_year_powerPS_minPrice_maxPrice_avgPrice_sdPrice)
```
